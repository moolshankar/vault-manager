app.controller("sshDashboardCtrl", function ($scope,$rootScope,$mdDialog,$http,$state,$window) {
    var userData = {};
    userData.name = $window.sessionStorage.getItem('user');;
    ...
    $scope.editUser = function(ev) {
            ...
            $mdDialog.show({
              templateUrl: '/vaultApp/sshManagement/User/EditUser/editUser.html',
